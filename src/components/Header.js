  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="iateam - Full stack Mobile and Web developer."
        ></meta>
      ...
      <header className="flex justify-content-space align-items-center py-2">
        ...
        <nav
          id="mob-menu"
          className={color === "light" ? "nav-links" : "nav-links-dark"}
        >
          <Link href="/" className="mx-1">
            Home
          </Link>
          <Link href="/portfolio" className="mx-1">
            Portfolio
          </Link>
          <Link href="/contact" className="mx-1">
            Contact
          </Link>
          <Link href="/resume" className="mx-1">
            Resume
          </Link>
          <Switcher
            state={lightmode}
